<template>
  ...
  >
    ...
    <section class="rounded-xl w-full h-96 overflow-auto">
      ...
      <el-empty v-if="!source?.length" class="text-gray-300 font-bold"
        >空空如也</el-empty
      >
    </section>
  </el-dialog>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(["getDialogTableVisible", "getUserDetail"]),
    dialogTableVisible: {
      get() {

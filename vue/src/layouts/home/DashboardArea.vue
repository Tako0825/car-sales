  ...
  <main class="w-full h-auto flex flex-col gap-6" v-loading="!dataReady">
    ...
    <article class="w-full h-80 flex justify-between gap-6">
      ...
      >
        ...
        />
        <div
          class="w-full h-full absolute top-0 left-0 z-10 cursor-pointer"
        ></div>
      </section>
    </article>
    <!-- 块行容器 -->
...
const DashboardChart = () =>
  import("@/views/home/dashboard-area/DashboardChart.vue");
const HistogramChart = () =>
  import("@/views/home/dashboard-area/HistogramChart.vue");
